  ...
  for (Int_t i_iwritten = 1; i_iwritten<2; i_iwritten++)
  {
    ...
    for (Int_t i_ND_LAr_dtctr_pos: a_ND_off_axis_pos_vec)
    {
      for (Int_t i_ND_LAr_vtx_pos: a_ND_vtx_vx_vec)
      {
        ...
        i_vtxX_plot +=1;
        TString HistEout_name = Form("HistEout_FDEvt_%d_vtxXpos_%d", i_iwritten, i_ND_LAr_vtx_pos);
        HistEout[i_iwritten-1][i_vtxX_plot-1] = new TH1D(HistEout_name, HistEout_name, 100, 0, 10000);
        TString HistVetoE_name = Form("HistVetoE_FDEvt_%d_vtxXpost_%d", i_iwritten, i_ND_LAr_vtx_pos);
        HistVetoE[i_iwritten-1][i_vtxX_plot-1] = new TH1D(HistVetoE_name, HistVetoE_name, 100, 0, 10000);
        TString HistEtrim_name = Form("HistEtrim_FDEvt_%d_vtxXpost_%d", i_iwritten, i_ND_LAr_vtx_pos);
        HistEtrim[i_iwritten-1][i_vtxX_plot-1] = new TH1D(HistEtrim_name, HistEtrim_name, 100, 0, 10000);
        ...
        for (i_entry ; i_entry < tot_size * (i_iwritten+1); i_entry++ )
        {
          ...
          if (ND_LAr_dtctr_pos == i_ND_LAr_dtctr_pos && ND_LAr_vtx_pos == i_ND_LAr_vtx_pos && ND_LAr_vtx_pos == 299)
          {
            ...
            for (Int_t ithrow = 0; ithrow < 5; ithrow++ )
            {
              ...
              HistEout[i_iwritten-1][i_vtxX_plot-1]->Fill(CurrentThrowoutEnergyND);
              HistVetoE[i_iwritten-1][i_vtxX_plot-1]->Fill(CurrentThrowvetoEnergyND);
            ...
            HistEout[i_iwritten-1][i_vtxX_plot-1]->Draw("hist");
            CanvasVetoE[i_vtxX_plot-1]->cd();
            HistVetoE[i_iwritten-1][i_vtxX_plot-1]->Draw("hist");
